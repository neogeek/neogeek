...
[GitHub Repo](https://github.com/neogeek/Smoothie-Operator) / [Itch.io](https://scottdoxey.itch.io/smoothie-operator-unity-port)
...
- [CandyCoded](https://github.com/CandyCoded/CandyCoded/) - This package is the core package with general tools for simplifying workflow in Unity.
- [ARFoundation-Components](https://github.com/CandyCoded/ARFoundation-Components/) - This package is for simplifying working with Unity's AR Foundation package.
...
- [unity-ci-tools](https://github.com/neogeek/unity-ci-tools) - This project contains a number of bash scripts that are set up to run tests on any Unity project on Travis CI or any other online CI service.
...
- [lumberlogs](https://github.com/neogeek/lumberlogs) - This is a desktop (macOS only) application that helps debug deployed Unity application by sending logs to a local IP. Logs can then be filtered from within the application.
